...
El funcionamiento de selección múltiple ahora tiene dos pasos:

1. El candidato selecciona una sola opción. Puede cambiarla mientras no confirme.
2. Al pulsar **Siguiente**, la respuesta se registra, se bloquea y se muestra si fue correcta o incorrecta.
3. Una segunda pulsación en **Siguiente** avanza a la próxima pregunta.

Volver atrás o recargar la página no permite modificar una respuesta que ya fue confirmada.
